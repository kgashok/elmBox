...
var _kgashok$elmbox$Version$version = 'v1.6-1-g90f0489';
...
var _kgashok$elmbox$Drop$appendStatus = function (model) {
	var _p3 = A2(_elm_lang$core$Debug$log, 'model: ', model.appendsPending);
...
if (typeof _kgashok$elmbox$Drop$main !== 'undefined') {
    _kgashok$elmbox$Drop$main(Elm['Drop'], 'Drop', {"types":{"unions":{"Dict.LeafColor":{"args":[],"tags":{"LBBlack":[],"LBlack":[]}},"Dom.Error":{"args":[],"tags":{"NotFound":["String"]}},"Dict.Dict":{"args":["k","v"],"tags":{"RBNode_elm_builtin":["Dict.NColor","k","v","Dict.Dict k v","Dict.Dict k v"],"RBEmpty_elm_builtin":["Dict.LeafColor"]}},"Drop.Msg":{"args":[],"tags":{"FocusDone":["Result.Result Dom.Error ()"],"Refresh":[],"Download":["Result.Result Http.Error ( Time.Time, Drop.FileInfo )"],"UploadStatus":["Result.Result Http.Error ( Time.Time, String )"],"UpdateStatus":["String"],"GetTime":[],"Upload":[],"GetTimeAndAppend":["Time.Time"],"Append":[],"NewTime":["Time.Time"],"DownloadAndAppend":["Result.Result Http.Error ( Time.Time, Drop.FileInfo )"]}},"Dict.NColor":{"args":[],"tags":{"BBlack":[],"Red":[],"NBlack":[],"Black":[]}},"Http.Error":{"args":[],"tags":{"BadUrl":["String"],"NetworkError":[],"Timeout":[],"BadStatus":["Http.Response String"],"BadPayload":["String","Http.Response String"]}},"Result.Result":{"args":["error","value"],"tags":{"Ok":["value"],"Err":["error"]}}},"aliases":{"Drop.FileInfo":{"args":[],"type":"{ rev : String, body : String }"},"Http.Response":{"args":["body"],"type":"{ url : String , status : { code : Int, message : String } , headers : Dict.Dict String String , body : body }"},"Time.Time":{"args":[],"type":"Float"}},"message":"Drop.Msg"},"versions":{"elm":"0.18.0"}});
}
