...
var _user$project$Version$version = 'v1.0-29-gde11474';
	...
	function (msg, model) {
		...
		switch (_p1.ctor) {
					...
					return A2(
						...
						A2(
							...
							A2(
								...
								_p2,
								A2(_user$project$Drop$updateContents, _p1._0._0._1, model))),
						{
							ctor: '::',
				...
				return A2(
					...
					A2(
						...
						_user$project$Drop$appendStatus(
							A2(_user$project$Drop$setTime, _p3, model))),
					{
						ctor: '::',
						_0: _user$project$Drop$focusUpdate,
						_1: {ctor: '[]'}
					...
					return A2(
						...
						A2(
							...
							A2(
								...
								'Upload successful!'),
							A2(_user$project$Drop$setTime, _p4, model)),
						{
							ctor: '::',
							_0: _user$project$Drop$focusUpdate,
							_1: {ctor: '[]'}
			...
			default:
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					A2(_user$project$Drop$setTime, _p1._0, model),
					{
						ctor: '::',
						_0: _user$project$Drop$focusUpdate,
						_1: {ctor: '[]'}
