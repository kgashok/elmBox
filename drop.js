...
var _user$project$Version$version = 'v1.0-25-g042c624';
		...
		switch (_p1.ctor) {
				...
				if (_p1._0.ctor === 'Ok') {
					...
					return A2(
						...
						_elm_lang$core$Native_Utils.update(
							model,
							{
								contents: _marcosh$elm_html_to_unicode$ElmEscapeHtml$unescape(_p1._0._0._1),
					...
					return A2(
						...
						_elm_lang$core$Native_Utils.update(
							model,
							{
								errorMessage: _elm_lang$core$Basics$toString(_p1._0._0)
							}),
						{ctor: '[]'});
				}
			case 'Append':
			...
			case 'GetTimeAndAppend':
				...
				var model_ = _elm_lang$core$Native_Utils.update(
					model,
					{
						currentTime: _elm_lang$core$Maybe$Just(_p3)
					});
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					_elm_lang$core$Native_Utils.update(
