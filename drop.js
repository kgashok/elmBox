...
var _user$project$Drop$Model = F3(
	function (a, b, c) {
		return {filePath: a, dropURL: b, contents: c};
	});
...
var _user$project$Drop$init = function (path) {
	return {
		ctor: '_Tuple2',
		_0: A3(_user$project$Drop$Model, path, 'https://content.dropboxapi.com/2/files/download', ''),
	...
	function (msg, model) {
		...
		if (_p0.ctor === 'Refresh') {
			...
			if (_p0._0.ctor === 'Ok') {
				return {
					ctor: '_Tuple2',
					_0: A3(_user$project$Drop$Model, model.filePath, model.dropURL, _p0._0._0),
				...
				_1: {
					...
					_1: {
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text(model.contents),
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
					}
