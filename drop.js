...
var _user$project$Version$version = 'v1.0-35-g47d1e28';
...
var _user$project$Drop$Model = F6(
	function (a, b, c, d, e, f) {
		return {filePath: a, dropURL: b, contents: c, status: d, currentTime: e, flashMessage: f};
	});
var _user$project$Drop$initialModel = A6(_user$project$Drop$Model, _user$project$Drop$filePath, _user$project$Drop$dropboxAPI, '', '', _elm_lang$core$Maybe$Nothing, 'Logger Ready');
				...
				if (_p3._0.ctor === 'Ok') {
					return A2(
						...
						A2(
							...
							'Download successful!',
							A2(
								_user$project$Drop$setTime,
								_p3._0._0._0,
								A2(_user$project$Drop$updateContents, _p3._0._0._1, model))),
						{
							ctor: '::',
