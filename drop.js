...
var _kgashok$elmbox$Drop$postSettings = {method: 'GET', headers: _kgashok$elmbox$Drop$downloadHeaders, url: '', body: _elm_lang$http$Http$emptyBody, expect: _elm_lang$http$Http$expectString, timeout: _elm_lang$core$Maybe$Nothing, withCredentials: false};
	...
	function (msg, model) {
		...
		switch (_p11.ctor) {
			...
			case 'GetTimeAndAppend':
				return A2(
					...
					A2(
						...
						'Append successful!',
						_kgashok$elmbox$Drop$appendStatus(
							A2(_kgashok$elmbox$Drop$setTime, _p11._0, model))),
					{
						ctor: '::',
						_0: _kgashok$elmbox$Drop$focusUpdate,
						_1: {ctor: '[]'}
			...
			case 'Upload':
				...
				var _p13 = model_.downloadSuccess;
				if (_p13 === true) {
					return A2(
						_elm_lang$core$Platform_Cmd_ops['!'],
						model_,
...
var _kgashok$elmbox$Drop$updateWithStorage = F2(
	function (msg, model) {
		var _p14 = A2(_kgashok$elmbox$Drop$update, msg, model);
		var nextModel = _p14._0;
		var nextCmd = _p14._1;
		return {
			ctor: '_Tuple2',
			_0: nextModel,
