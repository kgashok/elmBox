...
var _kgashok$elmbox$Drop$viewContents = F2(
	function (contents, rawMode) {
		...
		var inmultiple_lines = function (contents) {
...
var _kgashok$elmbox$Drop$expectRev = function (response) {
	var _p7 = A2(_elm_lang$core$Debug$log, 'headers: ', response.headers);
	var result = A2(
		_elm_lang$core$Maybe$withDefault,
		'NA',
		A2(_elm_lang$core$Dict$get, 'dropbox-api-result', response.headers));
	...
	var _p9 = A2(_elm_lang$core$Debug$log, 'res: ', result);
	var _p10 = revision;
	if (_p10.ctor === 'Ok') {
		var _p11 = A2(
			_elm_lang$core$Debug$log,
...
var _kgashok$elmbox$Drop$fileInfo = function (response) {
	var _p12 = A2(_elm_lang$core$Debug$log, 'headers: ', response);
...
var _kgashok$elmbox$Drop$metadataUpdate = function (response) {
	var _p13 = A2(_elm_lang$core$Debug$log, 'metadata: ', response);
	...
	function (msg, model) {
		...
		switch (_p14.ctor) {
				...
				if (_p14._0.ctor === 'Ok') {
					var model_ = A2(
						...
						A2(
							...
							_p14._0._0._1,
							A2(_kgashok$elmbox$Drop$setTime, _p14._0._0._0, model)));
					var _p15 = {ctor: '_Tuple2', _0: model.downloadFirst, _1: model.downloadSuccess};
					if (_p15._0 === false) {
						return A2(
							_elm_lang$core$Platform_Cmd_ops['!'],
							_elm_lang$core$Native_Utils.update(
			...
			case 'GetTimeAndAppend':
				return A2(
					...
					A2(
						...
						'Append successful!',
						_kgashok$elmbox$Drop$appendStatus(
							A2(_kgashok$elmbox$Drop$setTime, _p14._0, model))),
					{
						ctor: '::',
						_0: _kgashok$elmbox$Drop$focusUpdate,
						_1: {ctor: '[]'}
			...
			case 'Upload':
				...
				var _p16 = model_.downloadSuccess;
				if (_p16 === true) {
					return A2(
						_elm_lang$core$Platform_Cmd_ops['!'],
						model_,
...
var _kgashok$elmbox$Drop$updateWithStorage = F2(
	function (msg, model) {
		var _p18 = A2(_kgashok$elmbox$Drop$update, msg, model);
		var nextModel = _p18._0;
		var nextCmd = _p18._1;
		return {
			ctor: '_Tuple2',
			_0: nextModel,
